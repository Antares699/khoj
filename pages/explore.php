    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function renderResults() {
            ...
            filtered.forEach((biz, index) => {
                let imgUrl = '../assets/images/defaults/himalayan-kitchen.png';
                const cat = (biz.category || '').toLowerCase();
                if (cat.includes('hotel')) imgUrl = '../assets/images/defaults/hotel-barahi.jpg';
                if (cat.includes('healthcare')) imgUrl = '../assets/images/defaults/nepal-mediciti.jpg';
                if (cat.includes('salon') || cat.includes('beauty')) imgUrl = '../assets/images/defaults/hair-studio.jpg';
                if (cat.includes('shopping')) imgUrl = '../assets/images/defaults/bhatbhateni.jpg';
                if (cat.includes('service')) imgUrl = '../assets/images/defaults/quick-fix.jpeg';
