    ...
    <div class="auth-box">
        ...
        <?php if ($success): ?>
            <div style="background: #dcfce7; color: #166534; padding: 12px 16px; border-radius: 8px; font-size: 14px; margin-bottom: 16px;">
                ...
                <br><br>
                <a href="<?php echo $pagePrefix; ?>login.php" style="color: #166534; font-weight: bold; text-decoration: underline;">Go to Login</a>
            </div>
        <?php else: ?>
            <form method="POST">
        ...
        <p class="auth-footer">
            <a href="<?php echo $pagePrefix; ?>login.php" class="auth-link">Back to Login</a>
        </p>
    </div>
</div>
