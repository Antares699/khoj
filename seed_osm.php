...
$insertBiz = $conn->prepare("INSERT INTO businesses (owner_id, name, slug, category, description, location, phone, website, attributes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
foreach ($categories as $groupName => $config) {
    ...
    foreach ($data['elements'] as $element) {
        ...
        // Execute Insert
        $insertBiz->bind_param("issssssss", $ownerId, $name, $slug, $category, $description, $location, $phone, $website, $jsonAttributes);
